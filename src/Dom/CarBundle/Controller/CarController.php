...
use Dom\CarBundle\Entity\Car;
use Dom\CarBundle\Form\CarType;
...
class CarController extends Controller
{
    ...
    {
        $car = new Car();
        $form = $this->createForm('Dom\CarBundle\Form\CarType', $car);
    ...
    {
        $deleteForm = $this->createDeleteForm($car);
        $editForm = $this->createForm('Dom\CarBundle\Form\CarType', $car);
